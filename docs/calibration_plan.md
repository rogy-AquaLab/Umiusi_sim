...
>
> 時系列（control 側の git で確定）:
>
> | 期間 | ハードウェア到達レート | bag の 50 Hz 指令に対して |
> |---|---|---|
> | 〜2026-08-25（**8/21 の bag はここ**） | 6.25 Hz | **8:1 で間引き** |
> | 2026-08-25〜（`82752a8`） | 12.1 Hz | 4:1 |
> | `f7234df` 以降（未 push） | 50 Hz（期待値） | 1:1 |
>
